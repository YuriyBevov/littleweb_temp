...
document.addEventListener('DOMContentLoaded', function () {
  var title = document.querySelector('.welcome__form-title');
  title.style.transform = 'translateX(100px)';
  var controls = document.querySelectorAll('.welcome__form input');
  controls.forEach(function (control, i) {
    control.style.transform = "translateY(".concat(50 * (i + 1), "px)");
  });
  var button = document.querySelector('.welcome__form button');
  ...
  if (controls) {
    controls.forEach(function (control) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(control, {
        duration: 0.6,
        delay: 0.2,
        y: 0,
        opacity: 1,
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/form.js */ "./src/scripts/modules/form.js");
/* harmony import */ var _modules_iMask_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/iMask.js */ "./src/scripts/modules/iMask.js");
/* harmony import */ var _modules_animation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/animation.js */ "./src/scripts/modules/animation.js");
